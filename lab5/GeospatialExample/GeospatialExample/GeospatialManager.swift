...
class GeospatialManager: NSObject, ObservableObject, CLLocationManagerDelegate {
  ...
  private enum Constants {
    ...
    static let apiKey = "AIzaSyDPe0j6JccJu1YwtHoKMc1dZry_0PktrCE"
    ...
    static let horizontalAccuracyLowThreshold: CLLocationAccuracy = 200
    /// Horizontal accuracy threshold (meters) for being considered to lose "high accuracy"
    /// localization.
    static let horizontalAccuracyHighThreshold: CLLocationAccuracy = 40000
    /// Orientation yaw accuracy threshold (degrees) for being considered localized with
    /// "high accuracy".
    static let orientationYawAccuracyLowThreshold: CLLocationDirectionAccuracy = 200
    /// Orientation yaw accuracy threshold (degrees) for being considered to lose "high accuracy"
    /// localization.
    static let orientationYawAccuracyHighThreshold: CLLocationDirectionAccuracy = 400
    /// Give up localizing with high accuracy after 3 minutes.
    static let localizationFailureTime: TimeInterval = 20
  }
